...
LABEL com.vmware.cp.artifact.flavor="sha256:c50c90cfd9d12b445b011e6ad529f1ad3daea45c26d20b00732fae3cd71f6a83" \
      ...
      org.opencontainers.image.created="2024-11-16T00:30:23Z" \
      ...
      org.opencontainers.image.ref.name="4.5.0-debian-12-r5" \
...
RUN mkdir -p /tmp/bitnami/pkg/cache/ ; cd /tmp/bitnami/pkg/cache/ ; \
    COMPONENTS=( \
      ...
      "php-8.1.30-8-linux-${OS_ARCH}-debian-12" \
      "apache-2.4.62-4-linux-${OS_ARCH}-debian-12" \
      "postgresql-client-13.17.0-0-linux-${OS_ARCH}-debian-12" \
      "mysql-client-11.4.4-0-linux-${OS_ARCH}-debian-12" \
      "libphp-8.1.30-2-linux-${OS_ARCH}-debian-12" \
      "moodle-4.5.0-1-linux-${OS_ARCH}-debian-12" \
    ) ; \
...
# Configure locales with Japanese support
...
RUN update-locale LANG=ja_JP.UTF-8 LC_ALL=ja_JP.UTF-8 LANGUAGE=ja_JP:ja
